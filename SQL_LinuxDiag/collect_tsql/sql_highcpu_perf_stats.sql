...
CREATE PROCEDURE #sp_perf_high_cpu_snapshots @appname sysname='linuxdiag', @runtime datetime, @runtime_utc datetime
AS
SET NOCOUNT ON
BEGIN
	BEGIN TRY
  ...
  -- Main loop
	...
	BEGIN
		BEGIN TRY
			...
			EXEC #sp_perf_high_cpu_snapshots 'linuxdiag', @runtime = @runtime, @runtime_utc = @runtime_utc
