...
GO
CREATE PROCEDURE #sp_perf_virtual_file_stats @appname sysname='linuxdiag', @runtime DATETIME, @runtime_utc DATETIME
AS
SET NOCOUNT ON
BEGIN
    BEGIN TRY
...
GO
CREATE PROCEDURE #sp_perf_io_snapshots @appname sysname='linuxdiag', @runtime DATETIME, @runtime_utc DATETIME
AS
SET NOCOUNT ON
BEGIN
    BEGIN TRY
    ...
    -- Main loop
        ...
        BEGIN
            BEGIN TRY
                ...
                BEGIN
                    EXEC #sp_perf_virtual_file_stats 'linuxdiag', @runtime = @runtime, @runtime_utc = @runtime_utc
                END
                
                -- Collect sp_perf_high_io_snapshot every 3 minutes
                EXEC #sp_perf_io_snapshots 'linuxdiag', @runtime = @runtime, @runtime_utc = @runtime_utc
